...
use NinjaPortal\Mfa\Http\Requests\Admin\ResendMfaChallengeRequest;
use NinjaPortal\Mfa\Http\Requests\Admin\VerifyMfaChallengeRequest;

/**
 * @group MFA (Admin)
 *
 * Admin MFA challenge endpoints used after password login returns an MFA challenge.
 */
class MfaChallengeController extends Controller
{
    ...
    /**
     * Verify login MFA challenge (admin)
     *
     * Completes a pending admin login MFA challenge and issues tokens on success.
     *
     * @bodyParam challenge_token string required Opaque MFA challenge token returned from the admin login `202` response. Example: 5d2c9e8f4b6a1d3c7e9f0a2b4c6d8e0f5a1b3c7d9e2f4a6c8b0d1e3f5a7c9e1
    ...
    /**
     * Resend login MFA challenge (admin)
     *
     * Resends a code for resend-capable drivers (for example `email_otp`).
     *
     * @bodyParam challenge_token string required Opaque MFA challenge token returned from the admin login `202` response. Example: 5d2c9e8f4b6a1d3c7e9f0a2b4c6d8e0f5a1b3c7d9e2f4a6c8b0d1e3f5a7c9e1
     *
     * @response 200 {"success":true,"status":200,"message":"MFA code resent.","data":{"challenge_token":"<token>","driver":"email_otp","context":"admin","purpose":"login","expires_at":"2026-02-24T20:30:00Z","can_resend":true,"masked_destination":"a***n@example.com","resend_count":1,"max_resends":3,"sent_at":"2026-02-24T20:25:05Z","delivery":{"channel":"email"}},"meta":null}
